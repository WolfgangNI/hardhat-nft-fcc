...
// there are updates to the chance array, see chronological updates from the github! maybe those are solving my issues
    ...
    : describe("Random IPFS NFT Unit Tests", function () {
          ...
          describe("constructor", () => {
              it("sets starting values correctly", async function () {
                  ...
                  // const isInitialized = await randomIpfsNft.getInitialized() // getInitialized has been added to patties contract
          ...
          describe("getBreedFromModdedRng", () => {
              ...
              //   it("should revert if moddedRng > 99", async function () { this doesnt work and idk why it should...
              //     //   chanceArray = await randomIpfsNft.getChanceArray()
