...
1. Basic NFT
2. Random IPFS NFT - random at creation time to get true scarcity 
3. Dynamic SVG NFT - 100% hosted on chain, the image will change depending on some parameters (USD value of ETH)
